function [A, sortedjd, distance] = Get_A1_initial_sivt_simple1(station, satellite, jdmin, jdmax, jdjg, wdmin, wdmax, wdjg, gdmin, gdmax, gdjg,total_length)
...
parfor i = 1:n_rays
    ...
    try
        [A1, sorted_ddzb, distances] = Get_sta_A1_initial_sivt(...
