...
function [one_dimensional_index,sortedjd_ddzb,values] =Get_sta_A1_initial(XD,YD,ZD,XS,YS,ZS,jdmin,jdmax,jdjg,wdmin,wdmax,wdjg,gdmin,gdmax,gdjg,total_length,nj,nw,ng)
%%% Initialize output
