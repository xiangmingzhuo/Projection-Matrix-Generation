function [A, sortedjd, distance] = Get_A1_canshu_sivt_simple1(station, satellite, jdmin, jdmax, jdjg, wdmin, wdmax, wdjg, gdmin, gdmax, gdjg,total_length)
% Simplified version - Skips region checks, directly calculates all rays.
jd_params = [jdmin, jdmax, jdjg];    
wd_params = [wdmin, wdmax, wdjg];     
gd_params = [gdmin, gdmax, gdjg]; 
...
for i = 1:n_rays
    ...
    try
        [A1, sorted_ddzb, distances] = Get_sta_A1_canshu_sivt(...
            sx, sy, sz, sat_x, sat_y, sat_z, ...
            jd_params,wd_params,gd_params,total_length);
