...
function [one_dimensional_index,sortedjd_ddzb,values,jdmjd,wdmjd,gdmjd] = Get_sta_A1_tradition_sivt_optimized(XD,YD,ZD,XS,YS,ZS,jd_params,wd_params,gd_params,total_length,jdmin_rad,wdmin_rad,jdmax_rad,wdmax_rad,jdjg_rad,wdjg_rad)
% Initialize outputs
R = 6371000;
