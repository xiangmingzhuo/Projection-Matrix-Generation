...
function [one_dimensional_index,sortedjd_ddzb,values,station,satellite,scope_blh] = Get_sta_A1_sivt_optimized(XD,YD,ZD,XS,YS,ZS,jd_params,wd_params,gd_params,total_length,jdmin_rad,wdmin_rad,jdmax_rad,wdmax_rad,jdjg_rad,wdjg_rad)
%%% 初始化输出
R = 6371000;
station = [XD,YD,ZD];
satellite = [XS,YS,ZS];
