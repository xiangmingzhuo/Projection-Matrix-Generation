...
6.parametric equation method；(Get_A1_canshu_sivt_simple1.m)
7.Parametric equations + effective splitting surface scheme 2；	(Get_A1_canshu_sivt_simple2.m)
8.spherical trigonometry；(Get_A1_trangle_sivt_simple1.m)
9.Spherical trigonometry + effective splitting surface scheme 1；	(Get_A1_trangle_sivt_simple2.m)
10.Spherical trigonometry + effective splitting surface scheme 2；	(Get_A1_trangle_sivt_simple3.m)
