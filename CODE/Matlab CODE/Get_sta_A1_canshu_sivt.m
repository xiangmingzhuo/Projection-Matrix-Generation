...
function [one_dimensional_index, sortedjd_ddzb, distances] = Get_sta_A1_canshu_sivt(XD,YD,ZD,XS,YS,ZS,jd_params,wd_params,gd_params,total_length)
% Initialize output
...
if sortedjd_ddzb(3,1)> gdmin + 1  || sortedjd_ddzb(3,end)< gdmax - 1
    sortedjd_ddzb = [];
    return;
end  
