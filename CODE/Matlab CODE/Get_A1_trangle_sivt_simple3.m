function [A, sortedjd, distance] = Get_A1_trangle_sivt_simple3(station, satellite, jdmin, jdmax, jdjg, wdmin, wdmax, wdjg, gdmin, gdmax, gdjg,jdmin_rad,wdmin_rad,jdmax_rad,wdmax_rad,jdjg_rad,wdjg_rad,total_length)
...
for i = 1:n_rays
    ...
    try
        [A1, sorted_ddzb, distances] = Get_sta_A1_sivt_new_optimized(...
