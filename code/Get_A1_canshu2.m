function [A,L,sortedjd,distance]=Get_A1_canshu2(doy,Sites_Info,sate,jdmin,jdmax,jdjg,wdmin,wdmax,wdjg,gdmin,gdmax,gdjg,t)
nj=(jdmax-jdmin)/jdjg;
nw=(wdmax-wdmin)/wdjg;
ng=(gdmax-gdmin)/gdjg;
nx=nj*nw*ng;
...
parfor i=1:n_rg2
    ...
    for k=k0:k2
        for j=1:32
            ...
            % 球面三角计算
            [A1,sorted_ddzb,distances] = Get_sta_A1_canshu(sx,sy,sz,...
