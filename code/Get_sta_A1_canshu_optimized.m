%此函数用参数方程+有效分裂面法来对单独的射线生成A
function [one_dimensional_index, sortedjd_ddzb, distances] = Get_sta_A1_canshu_optimized(XD,YD,ZD,XS,YS,ZS,jdmin,jdmax,jdjg,wdmin,wdmax,wdjg,gdmin,gdmax,gdjg)
% 初始化输出
