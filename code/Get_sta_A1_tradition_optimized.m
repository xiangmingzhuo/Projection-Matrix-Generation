%此函数采用直接球面三角法来对单独的射线生成A
function [one_dimensional_index,sortedjd_ddzb,values,jdmjd,wdmjd,gdmjd] =Get_sta_A1_tradition_optimized(XD,YD,ZD,XS,YS,ZS,jdmin,jdmax,jdjg,wdmin,wdmax,wdjg,gdmin,gdmax,gdjg)
% 初始化输出
R = 6371000;
